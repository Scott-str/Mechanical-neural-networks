...
We introduce the mechanical analogue of in situ backpropagation to enable highly efficient training of Mechanical Neural Networks. With the exact gradient information, we showcase the successful training of MNNs for behavior learning and machine learning tasks, achieving high accuracy in regression and classification. The details of the approach are in our [paper]([https://doi.org/10.48550/arXiv.2404.15471](https://www.nature.com/articles/s41467-024-54849-z)). data.xlsx is the data file for generating figures in the paper.
## Setup
